    ...
    <div className="flex flex-nowrap overflow-x-scroll no-scrollbar md:block md:overflow-auto px-3 py-6 border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-700 min-w-[15rem] md:space-y-3">
      ...
      <div>
        ...
        <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <NavLink end to="/settings/byok" className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${pathname.includes('/settings/byok') && 'bg-indigo-50 dark:bg-indigo-500/30'}`}>
              <svg className={`w-4 h-4 shrink-0 fill-current mr-2 ${pathname.includes('/settings/byok') ? 'text-indigo-500 dark:text-indigo-400' : 'text-slate-400 dark:text-slate-500'}`} viewBox="0 0 16 16">
                <path d="M11.872 9.14a4.001 4.001 0 01-7.744 0A4.002 4.002 0 012 5V3a2 2 0 114 0v2a2 2 0 01-1.128 1.86zM6 3a1 1 0 10-2 0v2a1 1 0 102 0V3zm6 10H4a2 2 0 01-2-2v-1h12v1a2 2 0 01-2 2z" />
              </svg>
              <span className={`text-sm font-medium ${pathname.includes('/settings/byok') ? 'text-indigo-500 dark:text-indigo-400' : 'text-slate-600 dark:text-slate-300 hover:text-slate-700 dark:hover:text-slate-200'}`}>BYOK (API keys)</span>
            </NavLink>
          </li>
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
