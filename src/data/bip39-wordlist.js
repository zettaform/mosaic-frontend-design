...
export const BIP39_WORDS = [
  ...
  'chaos', 'chapter', 'charge', 'chase', 'cheap', 'check', 'cheese', 'chef', 'cherry', 'chest',
  ...
  'come', 'comfort', 'comic', 'common', 'company', 'concert', 'conduct', 'confirm', 'conquer', 'consent',
  ...
  'domain', 'donate', 'donkey', 'donor', 'door', 'dose', 'double', 'dove', 'down', 'dozen',
  ...
  'excess', 'exchange', 'excite', 'exclude', 'excuse', 'execute', 'exercise', 'exhaust', 'exist', 'exit',
  ...
  'fiscal', 'fish', 'five', 'fix', 'flag', 'flame', 'flash', 'flat', 'flavor', 'flee',
  ...
  'hard', 'harsh', 'harvest', 'hash', 'hasty', 'hat', 'have', 'hawk', 'hazard', 'head',
  ...
  'land', 'landscape', 'lane', 'language', 'laptop', 'large', 'later', 'latin', 'laugh', 'laundry',
  ...
  'lottery', 'loud', 'lounge', 'love', 'low', 'loyal', 'lucky', 'luggage', 'lumber', 'lunar',
  'lunch', 'luxury', 'lyrics', 'machine', 'mad', 'magic', 'magnet', 'maid', 'mail', 'main',
  'major', 'make', 'mammoth', 'man', 'manage', 'mandate', 'mango', 'mansion', 'manual', 'maple',
  ...
  'other', 'out', 'outdoor', 'outer', 'outline', 'outstanding', 'oval', 'oven', 'over', 'own',
  ...
  'pass', 'patch', 'path', 'patient', 'patrol', 'pattern', 'pause', 'pave', 'paw', 'pay',
  ...
  'pool', 'poor', 'pop', 'popcorn', 'popular', 'porch', 'port', 'portion', 'portrait', 'pose',
  ...
  'pulp', 'pulse', 'pumpkin', 'punch', 'pupil', 'puppy', 'purple', 'purpose', 'purse', 'push',
  ...
  'rent', 'reopen', 'repair', 'repeat', 'replace', 'reply', 'report', 'require', 'rescue', 'resemble',
  'resist', 'resort', 'resource', 'response', 'result', 'retire', 'retreat', 'return', 'reunion', 'reveal',
  ...
  'rough', 'round', 'route', 'royal', 'rubber', 'rude', 'rug', 'rule', 'rumor', 'run',
  'runway', 'rural', 'sad', 'saddle', 'sadness', 'safe', 'sail', 'salad', 'salmon', 'salon',
  'salt', 'salute', 'same', 'sample', 'sand', 'satisfy', 'satoshi', 'sauce', 'sausage', 'savage',
  ...
  'slab', 'slam', 'slang', 'slate', 'slave', 'sled', 'sleep', 'slender', 'slice', 'slide',
  'slight', 'slim', 'slogan', 'slot', 'slow', 'slurp', 'slush', 'sly', 'smack', 'small',
  'smart', 'smile', 'smoke', 'smooth', 'smuggle', 'snack', 'snake', 'snap', 'snare', 'snarl',
  'sneak', 'sneeze', 'sniff', 'snore', 'snort', 'snout', 'snow', 'snub', 'snuff', 'snug',
  'soak', 'soap', 'soar', 'sob', 'sober', 'soccer', 'social', 'sock', 'soda', 'soft',
  'soggy', 'soil', 'solar', 'soldier', 'solid', 'solve', 'someone', 'song', 'soon', 'sore',
  'sorrow', 'sorry', 'sort', 'soul', 'sound', 'soup', 'sour', 'south', 'space', 'spare',
  'spark', 'spatial', 'spawn', 'speak', 'speed', 'spell', 'spend', 'sphere', 'spice', 'spider',
  'spike', 'spin', 'spirit', 'spit', 'splash', 'split', 'spoil', 'sponsor', 'spoon', 'sport',
  'spot', 'spray', 'spread', 'spring', 'spy', 'square', 'squash', 'squeeze', 'squirrel', 'squirt',
  'stability', 'stable', 'stadium', 'staff', 'stage', 'stain', 'stair', 'stake', 'stale', 'stall',
  'stamp', 'stand', 'start', 'state', 'stay', 'steak', 'steal', 'steam', 'steel', 'steep',
  'stem', 'step', 'stereo', 'stick', 'still', 'sting', 'stink', 'stir', 'stitch', 'stock',
  'stomach', 'stone', 'stool', 'stoop', 'stop', 'store', 'storm', 'story', 'stove', 'straddle',
  'straight', 'strand', 'strange', 'strategy', 'straw', 'stray', 'stream', 'street', 'stretch', 'strict',
  'stride', 'strife', 'strike', 'string', 'strive', 'stroke', 'stroll', 'strong', 'struck', 'struggle',
  'strum', 'strut', 'stuck', 'study', 'stuff', 'stump', 'stung', 'stunned', 'stunt', 'style',
  'subdue', 'subject', 'submarine', 'substance', 'subtract', 'suburb', 'subway', 'success', 'such', 'sudden',
  'suffer', 'sugar', 'suggest', 'suit', 'sulky', 'sultry', 'summer', 'sun', 'sunny', 'sunset',
  'super', 'sure', 'surface', 'surge', 'surprise', 'surround', 'survey', 'suspect', 'sustain', 'swallow',
  'swamp', 'swap', 'swarm', 'sway', 'swear', 'sweat', 'sweep', 'sweet', 'swell', 'swept',
  'swift', 'swim', 'swing', 'switch', 'sword', 'swore', 'sworn', 'swung', 'syllable', 'symbol',
  'symptom', 'syrup', 'system', 'table', 'tackle', 'tag', 'tail', 'take', 'tale', 'talk',
  'tall', 'tank', 'tape', 'target', 'task', 'taste', 'tattoo', 'taught', 'tax', 'teach',
  'team', 'tear', 'tease', 'teen', 'teeth', 'telephone', 'tell', 'ten', 'tenant', 'tennis',
  'tent', 'term', 'test', 'text', 'thank', 'that', 'thaw', 'the', 'theater', 'theft',
  'theme', 'then', 'theory', 'there', 'they', 'thing', 'think', 'third', 'this', 'thong',
  'those', 'though', 'thought', 'thousand', 'thread', 'threat', 'three', 'threw', 'thrift', 'thrill',
  'throat', 'throne', 'through', 'throw', 'thrust', 'thumb', 'thump', 'thunder', 'thus', 'tick',
  'tide', 'tidy', 'tie', 'tiger', 'tight', 'tile', 'till', 'tilt', 'timber', 'time',
  'timid', 'tin', 'tiny', 'tip', 'tired', 'tissue', 'title', 'toad', 'toast', 'today',
  'toddler', 'toe', 'together', 'toilet', 'token', 'tomato', 'tomorrow', 'tone', 'tongue', 'tonight',
  'too', 'tool', 'tooth', 'top', 'topic', 'topple', 'torch', 'tornado', 'tortoise', 'toss',
  'total', 'toucan', 'touch', 'tough', 'tour', 'toward', 'towel', 'tower', 'town', 'toy',
  ...
  'trouble', 'truck', 'true', 'truly', 'trumpet', 'trust', 'truth', 'try', 'tube', 'tuck',
  'tuesday', 'tug', 'tuition', 'tulip', 'tumble', 'tuna', 'tunnel', 'turkey', 'turn', 'turtle',
  'twelve', 'twenty', 'twice', 'twin', 'twist', 'two', 'type', 'typical', 'ugly', 'umbrella',
  'unable', 'unaware', 'uncle', 'uncover', 'under', 'undo', 'unfair', 'unfold', 'unhappy', 'unique',
  'unit', 'universe', 'unknown', 'unload', 'unlock', 'until', 'unusual', 'unveil', 'unwind', 'unwise',
  'up', 'update', 'upgrade', 'uphold', 'upon', 'upper', 'upright', 'upset', 'urban', 'urge',
  'usage', 'use', 'used', 'useful', 'useless', 'usual', 'utility', 'vacant', 'vacuum', 'vague',
  'valley', 'valve', 'van', 'vanish', 'vapor', 'various', 'vast', 'vault', 'vaunt', 'veal',
  'vegan', 'veil', 'vein', 'velvet', 'vend', 'venom', 'vent', 'venue', 'verb', 'verdict',
  'verify', 'verse', 'version', 'versus', 'very', 'vessel', 'vest', 'veto', 'via', 'vibrate',
  'vicious', 'victory', 'video', 'view', 'village', 'vintage', 'violin', 'viper', 'virtual', 'virus',
  'visa', 'visit', 'visual', 'vital', 'vivid', 'vocal', 'voice', 'void', 'volcano', 'volume',
  'vote', 'vow', 'voyage', 'wade', 'waffle', 'wage', 'wagon', 'wait', 'wake', 'walk',
  'wall', 'walnut', 'walrus', 'wander', 'want', 'war', 'warm', 'warn', 'wash', 'wasp',
  'waste', 'water', 'wave', 'wax', 'way', 'weak', 'wealth', 'weapon', 'wear', 'weasel',
  'weather', 'web', 'wedding', 'weed', 'week', 'weird', 'welcome', 'west', 'wet', 'whale',
  'what', 'wheat', 'wheel', 'when', 'where', 'whip', 'whisper', 'whistle', 'white', 'who',
  'whole', 'whom', 'whose', 'why', 'wicked', 'wide', 'width', 'wife', 'wild', 'will',
  'win', 'wind', 'window', 'wine', 'wing', 'wink', 'winner', 'winter', 'wire', 'wisdom',
  'wise', 'wish', 'wisp', 'witness', 'wolf', 'woman', 'wonder', 'wood', 'wool', 'woozy',
  'word', 'work', 'world', 'worry', 'worse', 'worst', 'worth', 'would', 'wound', 'wrap',
  'wreck', 'wrestle', 'wrist', 'write', 'wrong', 'wrote', 'wrung', 'wry', 'yacht', 'yahoo',
  'yam', 'yard', 'yarn', 'yawn', 'year', 'yellow', 'yes', 'yesterday', 'yet', 'yield',
  'yoga', 'yoke', 'yolk', 'young', 'youth', 'zebra', 'zero', 'zesty', 'zilch', 'zinc',
  'zipper', 'zodiac', 'zombie', 'zone', 'zoo', 'zoom'
];
