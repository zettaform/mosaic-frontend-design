                ...
                <div className="max-w-md mx-auto w-full">
                  <div className="relative">
                    ...
                    <ul className="relative flex justify-between w-full">
                      ...
                      <li>
                        <Link className="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-indigo-500 text-white" to="/onboarding/complete">4</Link>
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <div className="px-4 py-8">
              <div className="max-w-md mx-auto">
                ...
                <div className="text-center">
                  ...
                  <h1 className="text-3xl text-slate-800 dark:text-slate-100 font-bold mb-8">Nice to have you, {currentUser?.username || currentUser?.email || 'User'} 🙌</h1>
                  <button onClick={handleFinish} className="btn bg-indigo-500 hover:bg-indigo-600 text-white disabled:opacity-50" disabled={finishing}>
