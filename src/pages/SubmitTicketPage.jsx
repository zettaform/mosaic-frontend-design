...
export default function SubmitTicketPage() {
  ...
  return (
    <div className="bg-gray-900">
      ...
      <main>
        {/* Support ticket form with design from provided code */}
        <div className="relative isolate bg-gray-900">
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-16">
            <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
              <div className="relative">
                ...
                <div className="mx-auto max-w-xl">
                  <h2 className="text-4xl font-semibold tracking-tight text-pretty text-white sm:text-5xl">Submit a Support Ticket</h2>
                  <p className="mt-6 text-lg/8 text-gray-400">
                    If you need help with MyMailGram, you can submit a support ticket using the box below. Our team will review your request and respond as quickly as possible.
                  </p>
                  <dl className="mt-10 space-y-4 text-base/7 text-gray-300">
                    <div className="flex gap-x-4">
                      ...
                      <dd>
                        <a href="mailto:support@mymailgram.com" className="hover:text-white">
                          support@mymailgram.com
                        </a>
                      </dd>
                    </div>
                    <div className="flex gap-x-4">
                  ...
                  <div className="mt-8">
                    ...
                    <p className="text-gray-400">
                      After you submit the form, your ticket will be sent to our support team. We will review your message and respond with the next steps or a solution.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <div className="mt-2.5">
                      <textarea
                        ...
                        name="description"
                        rows={6}
                        placeholder="Explain the issue or question in detail so we can assist you effectively"
                        className="block w-full rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
                      />
                    </div>
                  </div>
                  <div>
                    <label htmlFor="attachments" className="block text-sm/6 font-semibold text-white">
                    ...
                    <div className="mt-2.5">
                      <input
                        ...
                        className="block w-full rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-500 file:text-white hover:file:bg-indigo-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500"
                      />
                    </div>
                    <p className="mt-1 text-sm text-gray-400">
                      Upload a screenshot or file if it helps explain the issue
                    </p>
                  </div>
                </div>
