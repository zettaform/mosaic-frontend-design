...
function OnboardingComplete() {
  ...
  const handleFinish = useCallback(async () => {
    ...
    try {
      // Get all onboarding data to complete the process
      const response = await onboardingService.completeOnboarding(user.user_id, {
            ...
            <div className="px-4 py-8">
              <div className="max-w-md mx-auto">
                ...
                <div className="text-center">
                  ...
                  <h1 className="text-3xl text-slate-800 dark:text-slate-100 font-bold mb-8">Nice to have you, {user?.first_name || user?.email || 'User'} 🙌</h1>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 mb-8">
                    Your onboarding is complete! You're all set to start using our platform.
                  </p>
