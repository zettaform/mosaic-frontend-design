...
function ModalSearch({
  ...
  return (
    <>
      {/* Modal backdrop */}
      <Transition
        className="fixed inset-0 bg-slate-900 bg-opacity-30 z-[9999] transition-opacity"
        show={modalOpen}
      ...
      <Transition
        id={id}
        className="fixed inset-0 z-[9999] overflow-hidden flex items-start top-20 mb-4 justify-center px-4 sm:px-6"
        role="dialog"
        aria-modal="true"
        show={modalOpen}
